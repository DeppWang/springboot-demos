package wang.depp.providerclient.support;
...
import wang.depp.substruction.common.utils.LogUtils;
...
@Slf4j
public class AccessTraceHttpClient implements Client {
    ...
    public AccessTraceHttpClient(HttpClient client, RequestConfig requestConfig) {
        this.client = client;
    ...
    public Response execute(Request request, Request.Options options) throws IOException {
        ...
        Response response = toFeignResponse(httpResponse, request);
        return response;
    }
    ...
    HttpUriRequest toHttpUriRequest(Request request, Request.Options options)
        ...
        requestBuilder.addParameter("traceId", LogUtils.getTraceId());
